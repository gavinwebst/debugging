...
namespace GDAPS_DebuggingStarter
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(percentage+" of "+userNumber1AsString+" is "+userNumberAsPercentage);
            ...
            double userAngleAsRad = Math.Round(userAngleAsInt * Math.PI / 180.0, 2);
            Console.WriteLine(
                "Converting to radians... " +                       //
                $"{userAngleAsInt} degrees is " +                   // 60 degrees
                $"{(userAngleAsInt * Math.PI) / 180.0} radians.");      // 1.0471975511965976 radians
            double sineOfAngle = Math.Sin(userAngleAsRad);
            Console.WriteLine(
                $"The sine of " +
                $"{userAngleAsRad} radians is " +                   // 1.05 radians
            ...
            newName = userName.Substring(userName.Length) + userName[1..]+ userName[0];    // milyE
